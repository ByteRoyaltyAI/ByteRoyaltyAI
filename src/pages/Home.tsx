      ...
      <main className="relative">
        <Suspense fallback={<div>Loading...</div>}>
          ...
          <GlassmorphismWrapper>
            ...
            /> */}
            <div className="py-40 pb-72 flex justify-center">
             <h3 className="text-[--blue] text-center text-[35px]  sm:text-[3.2rem] max-lg:mb-10 max-lg:leading-tight w-[90%] sm:w-2/3">
