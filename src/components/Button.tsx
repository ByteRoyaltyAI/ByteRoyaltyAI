...
const Button: React.FC<ButtonProps> = ({
  ...
  const commonProps = {
    onClick,
    type,
    className: `text-white drop-shadow-2xl border-none py-5 px-10 rounded-lg text-[2rem] transition-all duration-200 flex flex-row gap-4 justify-center items-center cursor-pointer ${buttoncolor} ${buttonhovercolor} max-lg:text-3xl max-lg:py-8 max-lg:px-16 max-lg:rounded-xl
