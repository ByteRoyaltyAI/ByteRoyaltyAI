  ...
  return (
    <div className='flex flex-col gap-60 min-h-screen mt-[20rem]'>
      ...
      <div className='flex justify-center mb-32'>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-center items-center  gap-10 lg:gap-20 xl:gap-32 w-[90%] pb-16'>
          {productData.cards?.map((card, index) => (
            <Link to={`/product/hrServices/${card.link}`} key={index} className="">
